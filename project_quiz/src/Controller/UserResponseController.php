...
class UserResponseController extends AbstractController
{
    /**
     * ======================================
     * 1️⃣ ANSWER ONE QUESTION (OPTIONAL)
     * ======================================
     */
