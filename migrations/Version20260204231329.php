 ...
 */
final class Version20260204231329 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE mouvement (id_mo INT AUTO_INCREMENT NOT NULL, type_m VARCHAR(255) NOT NULL, quantite INT NOT NULL, date_mouvement DATE NOT NULL, motif VARCHAR(255) NOT NULL, id_p INT NOT NULL, INDEX IDX_5B51FC3E459234CE (id_p), PRIMARY KEY (id_mo)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
