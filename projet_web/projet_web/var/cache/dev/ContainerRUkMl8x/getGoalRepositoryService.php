...
{
    /**
     * Gets the private 'App\Repository\GoalRepository' shared autowired service.
     *
     * @return \App\Repository\GoalRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GoalRepository.php';

        return $container->privates['App\\Repository\\GoalRepository'] = new \App\Repository\GoalRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
