 ...
 */
final class Version20260227221628 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE goal ADD success_score DOUBLE PRECISION DEFAULT NULL, ADD ai_success_score INT DEFAULT NULL, ADD ai_success_advice LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE goal DROP success_score, DROP ai_success_score, DROP ai_success_advice');
