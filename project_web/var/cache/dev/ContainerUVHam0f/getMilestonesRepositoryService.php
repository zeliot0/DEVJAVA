 ...
 */
class getMilestonesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MilestonesRepository' shared autowired service.
     *
     * @return \App\Repository\MilestonesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MilestonesRepository.php';

        return $container->privates['App\\Repository\\MilestonesRepository'] = new \App\Repository\MilestonesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
