 ...
 */
class getMotivationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MotivationRepository' shared autowired service.
     *
     * @return \App\Repository\MotivationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MotivationRepository.php';

        return $container->privates['App\\Repository\\MotivationRepository'] = new \App\Repository\MotivationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
