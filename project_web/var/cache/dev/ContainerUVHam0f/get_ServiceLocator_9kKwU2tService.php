...
class get_ServiceLocator_9kKwU2tService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.9kKwU2t'])) {
            return $container->privates['.service_locator.9kKwU2t'];
        }

        return $container->privates['.service_locator.9kKwU2t'] = $instance;
    }
}
