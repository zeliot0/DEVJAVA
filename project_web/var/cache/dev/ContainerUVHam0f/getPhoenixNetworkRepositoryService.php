 ...
 */
class getPhoenixNetworkRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PhoenixNetworkRepository' shared autowired service.
     *
     * @return \App\Repository\PhoenixNetworkRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PhoenixNetworkRepository.php';

        return $container->privates['App\\Repository\\PhoenixNetworkRepository'] = new \App\Repository\PhoenixNetworkRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
