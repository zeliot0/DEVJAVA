 ...
 */
class getTimeMessageRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TimeMessageRepository' shared autowired service.
     *
     * @return \App\Repository\TimeMessageRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TimeMessageRepository.php';

        return $container->privates['App\\Repository\\TimeMessageRepository'] = new \App\Repository\TimeMessageRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
