 ...
 */
class getMoodClickRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MoodClickRepository' shared autowired service.
     *
     * @return \App\Repository\MoodClickRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MoodClickRepository.php';

        return $container->privates['App\\Repository\\MoodClickRepository'] = new \App\Repository\MoodClickRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
