...
class get_ServiceLocator_WoAniWUService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.WoAniWU'])) {
            return $container->privates['.service_locator.WoAniWU'];
        }

        return $container->privates['.service_locator.WoAniWU'] = $instance;
    }
}
