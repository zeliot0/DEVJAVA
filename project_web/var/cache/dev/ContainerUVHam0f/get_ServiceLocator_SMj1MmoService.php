...
class get_ServiceLocator_SMj1MmoService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.SMj1Mmo'])) {
            return $container->privates['.service_locator.SMj1Mmo'];
        }

        return $container->privates['.service_locator.SMj1Mmo'] = $instance;
    }
}
