 ...
 */
class getPhoenixWisdomRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PhoenixWisdomRepository' shared autowired service.
     *
     * @return \App\Repository\PhoenixWisdomRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PhoenixWisdomRepository.php';

        return $container->privates['App\\Repository\\PhoenixWisdomRepository'] = new \App\Repository\PhoenixWisdomRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
