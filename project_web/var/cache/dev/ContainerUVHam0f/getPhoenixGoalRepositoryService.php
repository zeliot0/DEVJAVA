 ...
 */
class getPhoenixGoalRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PhoenixGoalRepository' shared autowired service.
     *
     * @return \App\Repository\PhoenixGoalRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PhoenixGoalRepository.php';

        return $container->privates['App\\Repository\\PhoenixGoalRepository'] = new \App\Repository\PhoenixGoalRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
