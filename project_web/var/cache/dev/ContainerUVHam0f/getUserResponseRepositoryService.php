 ...
 */
class getUserResponseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserResponseRepository' shared autowired service.
     *
     * @return \App\Repository\UserResponseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserResponseRepository.php';

        return $container->privates['App\\Repository\\UserResponseRepository'] = new \App\Repository\UserResponseRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
