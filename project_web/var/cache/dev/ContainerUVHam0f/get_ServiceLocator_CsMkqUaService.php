...
class get_ServiceLocator_CsMkqUaService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.CsMkqUa'])) {
            return $container->privates['.service_locator.CsMkqUa'];
        }

        return $container->privates['.service_locator.CsMkqUa'] = $instance;
    }
}
