...
class __TwigTemplate_be384d115e7ddcbd4e03cbf7ecb52b9a extends Template
{
...
<style";
        // line 12
        if ((($tmp = (isset($context["csp_style_nonce"]) || array_key_exists("csp_style_nonce", $context) ? $context["csp_style_nonce"] : (function () { throw new RuntimeError('Variable "csp_style_nonce" does not exist.', 12, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            yield " nonce=\"";
...
";
    ...
    Sfjs.loadToolbar('";
        // line 656
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new RuntimeError('Variable "token" does not exist.', 656, $this->source); })()), "html", null, true);
        yield "');
/*]]>*/</script>
";
    ...
    {
        return array (  749 => 656,  717 => 627,  626 => 539,  480 => 395,  448 => 366,  442 => 363,  438 => 362,  432 => 359,  428 => 358,  382 => 315,  361 => 296,  359 => 295,  75 => 19,  69 => 13,  61 => 12,  56 => 9,  54 => 7,  53 => 2,  48 => 1,);
    }
...
/*]]>*/</script>
", "@WebProfiler/Profiler/toolbar_js.html.twig", "C:\\Users\\Siwar\\Desktop\\bal de projet finalll\\project_web\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Profiler\\toolbar_js.html.twig");
    }
}
