...
class __TwigTemplate_0633d0f67ac1c9a6fa6cfe958fca30ab extends Template
{
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('app_question_delete', {'id': question.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ question.id) }}\">
    <button class=\"btn\">Delete</button>
</form>
", "question/_delete_form.html.twig", "C:\\Users\\Siwar\\Desktop\\bal de projet finalll\\project_web\\templates\\question\\_delete_form.html.twig");
    }
}
